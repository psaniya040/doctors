      ...
      <div className="contact-content-wrapper">
        ...
        <section className="contact-info-section">
          ...
          <div className="info-card">
            ...
            <p>
              [span_0](start_span)For text-based communication between patients and healthcare providers, please log in to your dashboard and use the integrated chat messaging feature[span_0](end_span).
            </p>
          </div>
